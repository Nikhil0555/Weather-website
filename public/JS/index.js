...
console.log("Client side of web server")
...
weatherform.addEventListener('submit',(event)=>{
    ...
    fetch('http://localhost:3000/weather?address='+ location ).then((response)=>{      //fetch data from this url and then run this function
